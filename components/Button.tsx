...
export default function CheckPrimaryBtn({ label, onClick, loading }: { label: string, onClick: (...args: any[]) => void, loading?: boolean }) {
    ...
    return (
        <m.button
            ...
            <div className={"px-2 py-1 bg-foreground rounded  transition-all duration-100 "     }>
